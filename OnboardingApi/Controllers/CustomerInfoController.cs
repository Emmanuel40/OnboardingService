...
namespace OnboardingApi.Controllers
{
    ...
    public class CustomerInfoController : ControllerBase
    {
        ...
        public CustomerInfoController(ICustomerInfoService customerInfoService,IAlatService alatService)
        {
        ...
        public async Task<IActionResult> GetBanks()
        {
            ...
            var res = await _alatService.GetBanks().ConfigureAwait(false);
